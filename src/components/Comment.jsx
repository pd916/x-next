  ...
  return (
    <div>
      ...
      isOpen={open}
        ...
        bg-white border-2 border-gray-200 rounded-lg shadaw-md">
        <div className='p-4'>
            ...
            <div className='p-2 items-center space-x-1 relative'>
            ...
            <div className='flex p-3 space-x-3'>
              <img src={session.user.img} alt='user-img' className='h-11 w-11 rounded-full cursor-pointer
               hover:brightness-95'/>
